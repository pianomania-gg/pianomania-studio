...
int ConsoleApp::processConverter(const CmdOptions::ConverterTask& task)
{
    ...
    case ConvertType::File: {
        ...
        ret = converter()->fileConvert(task.inputFile, task.outputFile, stylePath, forceMode, soundProfile, extensionUri,
                                       transposeOptionsJson, pianomaniaAutoLayout, pianomaniaPrettify);
    } break;
    ...
    case ConvertType::ExportPianomaniaMidi: {
        ...
        ret = converter()->exportPianomaniaMidi(task.inputFile, task.outputFile, meiPath, manifestPath,
                                                stylePath, forceMode, pianomaniaAutoLayout);
    } break;
