...
struct CmdOptions {
    enum class ParamKey {
        ...
        PianomaniaExportMeiPath,
        PianomaniaExportManifestPath,
        PianomaniaExportPdfPath,
        PianomaniaForceNormalizeSlursFingerings,
    ...
    struct {
        ...
        bool pianomaniaReleaseSmokeTest = false;
    } app;
