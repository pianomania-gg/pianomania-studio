...
{
    std::string title = muse::trc("preferences", "Exit Pianomania?");
    std::string body = muse::trc("preferences", "Are you sure you want to exit?");
    ...
    auto promise = interactive()->warning(title, body,
                                          { cancelBtn,
                                            IInteractive::ButtonData(exitBtn, muse::trc("preferences", "Exit")) },
