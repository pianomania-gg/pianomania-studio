...
Ret ConverterUtils::applyPianomaniaAutoLayout(const INotationPtr notation)
{
    INotationInteractionPtr interaction = notation ? notation->interaction() : nullptr;
    if (!interaction) {
        return make_ret(Ret::Code::InternalError);
    ...
    interaction->applyPianomaniaAutoLayout();
    return make_ret(Ret::Code::Ok);
}

Ret ConverterUtils::applyPianomaniaPrettify(const INotationPtr notation)
{
    INotationInteractionPtr interaction = notation ? notation->interaction() : nullptr;
    if (!interaction) {
        return make_ret(Ret::Code::InternalError);
    ...
    interaction->applyPianomaniaPrettify();
    return make_ret(Ret::Code::Ok);
}
