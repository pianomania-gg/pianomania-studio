...
public:
    ...
    muse::Ret fileConvert(const muse::io::path_t& in, const muse::io::path_t& out,
                          ...
                          bool pianomaniaPrettify = false) override;
    ...
    muse::Ret exportPianomaniaMidi(const muse::io::path_t& in, const muse::io::path_t& basePath,
                                   const muse::io::path_t& meiPath,
                                   const muse::io::path_t& manifestPath,
                                   const muse::io::path_t& stylePath = muse::io::path_t(), bool forceMode = false,
                                   bool pianomaniaAutoLayout = false) override;
...
private:
    ...
    muse::Ret fileConvert(const muse::io::path_t& in, const muse::io::path_t& out,
                          ...
                          const std::optional<notation::TransposeOptions>& transposeOptions = std::nullopt,
                          bool pianomaniaAutoLayout = false,
                          bool pianomaniaPrettify = false);
