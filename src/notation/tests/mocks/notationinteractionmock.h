...
public:
    ...
    MOCK_METHOD(void, addRubatoZoneToSelection, (), (override));
    MOCK_METHOD(void, addPyroSpanToSelection, (), (override));
    MOCK_METHOD(void, addLaserSpanToSelection, (), (override));
    ...
    MOCK_METHOD(void, applyPianomaniaAutoLayout, (), (override));
    MOCK_METHOD(void, applyPianomaniaPrettify, (), (override));
