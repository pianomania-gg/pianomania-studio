...
public:
    ...
    void addRubatoZoneToSelection() override;
    void addPyroSpanToSelection() override;
    void addLaserSpanToSelection() override;
    ...
    void applyPianomaniaAutoLayout() override;
    void applyPianomaniaPrettify() override;
