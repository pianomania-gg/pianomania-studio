...
public:
    ...
    virtual void addRubatoZoneToSelection() = 0;
    virtual void addPyroSpanToSelection() = 0;
    virtual void addLaserSpanToSelection() = 0;
    ...
    virtual void applyPianomaniaAutoLayout() = 0;
    virtual void applyPianomaniaPrettify() = 0;
