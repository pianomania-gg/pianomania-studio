...
void InstrumentsOnScoreListModel::load()
{
    ...
    if (instruments.isEmpty()) {
        const QString defaultInstrumentId = QStringLiteral("piano");
        const InstrumentTemplate& templ = repository()->instrumentTemplate(defaultInstrumentId);
        ...
        if (templ.isValid()) {
            ...
            LOGW() << "Default instrument template not found: " << defaultInstrumentId;
        }
    }
