...
const UiActionList NotationUiActions::s_actions = {
    ...
    UiAction("pm-auto-layout",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
             TranslatableString("action", "&Auto Layout"),
             TranslatableString("action", "Set spatium to 0.07, remove title and composer, and lay out measures")
             ),
    UiAction("pm-prettify-force",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
             TranslatableString("action", "&Prettify"),
             TranslatableString("action", "Update all slurs and fingerings, including manual placements")
             ),
    UiAction("zoomin",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_OPENED,
    ...
    UiAction("held-note",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Held Note"),
             TranslatableString("action", "Insert a held note (rainbow button)")
             ),
    UiAction("held-note-settings",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Held Note settings"),
             TranslatableString("action", "Held Note settings"),
             IconCode::Code::EDIT
             ),
    UiAction("held-note-pulse-quarter",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Quarter-note pulse"),
             TranslatableString("action", "Quarter-note pulse"),
             IconCode::Code::NOTE_QUARTER
             ),
    UiAction("held-note-pulse-eighth",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Eighth-note pulse"),
             TranslatableString("action", "Eighth-note pulse"),
             IconCode::Code::NOTE_8TH
             ),
    UiAction("held-note-pulse-sixteenth",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Sixteenth-note pulse"),
             TranslatableString("action", "Sixteenth-note pulse"),
             IconCode::Code::NOTE_16TH
             ),
    UiAction("held-note-pulse-thirty-second",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Thirty-second-note pulse"),
             TranslatableString("action", "Thirty-second-note pulse"),
             IconCode::Code::NOTE_32ND
             ),
    UiAction("held-note-pulse-sixty-fourth",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Sixty-fourth-note pulse"),
             TranslatableString("action", "Sixty-fourth-note pulse"),
             IconCode::Code::NOTE_64TH
             ),
    UiAction("held-note-pulse-triplet",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Triplet pulse"),
             TranslatableString("action", "Triplet pulse"),
             IconCode::Code::NOTE_TUPLET
             ),
    UiAction("shake-note",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Bass Shake"),
             TranslatableString("action", "Mark notes to trigger a bass shake")
             ),
    UiAction("left-hand",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Left Hand"),
             TranslatableString("action", "Mark notes as left hand")
             ),
    UiAction("right-hand",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Right Hand"),
             TranslatableString("action", "Mark notes as right hand")
             ),
    UiAction("hand-visuals",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Hand Visuals"),
             TranslatableString("action", "Show or hide Pianomania hand visuals")
             ),
    UiAction("rubato-zone",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Rubato Zone"),
             TranslatableString("action", "Mark the selected range as a rubato zone")
             ),
    UiAction("pyro-span",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Pyro Span"),
             TranslatableString("action", "Mark the selected range for pyro effects")
             ),
    UiAction("laser-span",
             mu::context::UiCtxProjectOpened,
             mu::context::CTX_NOTATION_FOCUSED,
             TranslatableString("action", "Laser Span"),
             TranslatableString("action", "Mark the selected range for laser effects")
             ),
};
