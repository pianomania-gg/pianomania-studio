...
void NotationActionController::init()
{
    ...
    registerAction("rubato-zone", &Interaction::addRubatoZoneToSelection, &Controller::noteOrRestSelected);
    registerAction("pyro-span", &Interaction::addPyroSpanToSelection, &Controller::noteOrRestSelected);
    registerAction("laser-span", &Interaction::addLaserSpanToSelection, &Controller::noteOrRestSelected);
    ...
    registerAction("pm-auto-layout", &Interaction::applyPianomaniaAutoLayout);
    registerAction("pm-prettify-force", &Interaction::applyPianomaniaPrettify);
