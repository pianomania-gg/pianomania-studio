...
MenuItemList NotationContextMenuModel::makeItemsByElementType(ElementType elementType)
{
    ...
    case ElementType::MEASURE:
        items = makeMeasureItems();
        break;
    case ElementType::PAGE:
        items = makePageItems();
        break;
    case ElementType::STAFF_TEXT:
        items = makeStaffTextItems();
        break;
    case ElementType::SYSTEM_TEXT:
    case ElementType::TRIPLET_FEEL:
        items = makeSystemTextItems();
        break;
    case ElementType::TIMESIG:
        items = makeTimeSignatureItems();
        break;
    case ElementType::INSTRUMENT_NAME:
        items = makeInstrumentNameItems();
        break;
    case ElementType::HARMONY:
        items = makeHarmonyItems();
        break;
    case ElementType::FRET_DIAGRAM:
        items = makeFretboardDiagramItems();
        break;
    case ElementType::INSTRUMENT_CHANGE:
        items = makeChangeInstrumentItems();
        break;
    case ElementType::VBOX:
        items = makeVerticalBoxItems();
        break;
    case ElementType::HBOX:
        items = makeHorizontalBoxItems();
        break;
    case ElementType::HAIRPIN_SEGMENT:
        items = makeHairpinItems();
        break;
    case ElementType::GRADUAL_TEMPO_CHANGE_SEGMENT:
        items = makeGradualTempoChangeItems();
        break;
    case ElementType::TEXT:
        items = makeTextItems();
        break;
    default:
        items = makeElementItems();
        break;
    }

    appendPianomaniaItems(items);
    return items;
}
...
MenuItemList NotationContextMenuModel::makePianomaniaItems()
{
    MenuItemList items {
        makeMenuItem("pm-auto-layout"),
        makeMenuItem("pm-prettify-force"),
    };

    return items;
}

void NotationContextMenuModel::appendPianomaniaItems(MenuItemList& items)
{
    items << makeSeparator();
    items << makePianomaniaItems();
}
