...
public:
    ...
    static void write(const RubatoZone* item, XmlWriter& xml, WriteContext& ctx);
    static void write(const PyroSpan* item, XmlWriter& xml, WriteContext& ctx);
    static void write(const LaserSpan* item, XmlWriter& xml, WriteContext& ctx);
