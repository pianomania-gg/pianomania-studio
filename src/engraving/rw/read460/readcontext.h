...
#include "../compat/pianomaniaheldnotepitchcurvemigration.h"
...
public:
    ...
    compat::PianomaniaHeldNotePitchCurveMigration& pianomaniaHeldNotePitchCurveMigration()
    {
        return m_pianomaniaHeldNotePitchCurveMigration;
    }
...
private:
    ...
    compat::PianomaniaHeldNotePitchCurveMigration m_pianomaniaHeldNotePitchCurveMigration;
