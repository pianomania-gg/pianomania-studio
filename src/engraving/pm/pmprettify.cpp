...
PianomaniaPrettifyTargets collectPianomaniaPrettifyTargets(Score* score)
{
    ...
    score->scanElements([&targets](EngravingItem* item) { collectPianomaniaPrettifyFingerings(&targets, item); });
...
PianomaniaPrettifySnapshot collectPianomaniaPrettifySnapshot(Score* score)
{
    ...
    score->scanElements([&snapshot](EngravingItem* item) { collectPianomaniaPrettifySnapshotFingerings(&snapshot, item); });
...
void neutralizePianomaniaPrettifyProperties(Score* score, const PmPrettifyOptions& options, PmPrettifyResult& result)
{
    ...
    score->scanElements([&result](EngravingItem* item) { collectPianomaniaPrettifyNeutralizeFingerings(&result, item); });
}
