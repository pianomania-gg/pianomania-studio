...
static const std::array ELEMENT_TYPES {
    ...
    Item{ ElementType::WHAMMY_BAR_SEGMENT, "WhammyBarSegment",
          ...
          TranslatableString("engraving", "Whammy bar segment(s)", nullptr, 1) },
    Item{ ElementType::RUBATO_ZONE_SEGMENT, "RubatoZoneSegment",
          TranslatableString("engraving", "rubato zone segment(s)", nullptr, 1),
          TranslatableString("engraving", "Rubato zone segment(s)", nullptr, 1) },
    Item{ ElementType::PYRO_SPAN_SEGMENT, "PyroSpanSegment",
          TranslatableString("engraving", "pyro span segment(s)", nullptr, 1),
          TranslatableString("engraving", "Pyro span segment(s)", nullptr, 1) },
    Item{ ElementType::LASER_SPAN_SEGMENT, "LaserSpanSegment",
          TranslatableString("engraving", "laser span segment(s)", nullptr, 1),
          TranslatableString("engraving", "Laser span segment(s)", nullptr, 1) },
    ...
    Item{ ElementType::WHAMMY_BAR, "WhammyBar",
          ...
          TranslatableString("engraving", "Whammy bar(s)", nullptr, 1) },
    Item{ ElementType::RUBATO_ZONE, "RubatoZone",
          TranslatableString("engraving", "rubato zone(s)", nullptr, 1),
          TranslatableString("engraving", "Rubato zone(s)", nullptr, 1) },
    Item{ ElementType::PYRO_SPAN, "PyroSpan",
          TranslatableString("engraving", "pyro span(s)", nullptr, 1),
          TranslatableString("engraving", "Pyro span(s)", nullptr, 1) },
    Item{ ElementType::LASER_SPAN, "LaserSpan",
          TranslatableString("engraving", "laser span(s)", nullptr, 1),
          TranslatableString("engraving", "Laser span(s)", nullptr, 1) },
...
const std::array<Item<TrillType>, 5> TRILL_TYPES = { {
    ...
    { TrillType::TURN_BETWEEN,    "turn",       muse::TranslatableString("engraving/trilltype", "Turn between notes") }
} };
