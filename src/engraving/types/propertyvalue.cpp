...
QVariant PropertyValue::toQVariant() const
{
    ...
    case P_TYPE::PIANOMANIA_HELD_NOTE_PITCH_CURVE:
        return pianomaniaHeldNotePitchCurveToQVariant(value<PianomaniaHeldNotePitchCurve>());
...
PropertyValue PropertyValue::fromQVariant(const QVariant& v, P_TYPE type)
{
    ...
    case P_TYPE::PIANOMANIA_HELD_NOTE_PITCH_CURVE:
        return pianomaniaHeldNotePitchCurveFromQVariant(v);
