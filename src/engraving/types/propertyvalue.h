...
enum class P_TYPE : unsigned char {
    ...
    CHANGE_METHOD,
    PITCH_VALUES,
    PIANOMANIA_HELD_NOTE_PITCH_CURVE,
    TEMPO,
...
public:
    ...
    PropertyValue(const PianomaniaHeldNotePitchCurve& v)
        : m_type(P_TYPE::PIANOMANIA_HELD_NOTE_PITCH_CURVE), m_data(make_data<PianomaniaHeldNotePitchCurve>(v)) {}
