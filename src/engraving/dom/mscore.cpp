...
bool MScore::showPianomaniaHands;
bool MScore::pianomaniaPrettifySlursFingerings = false;
bool MScore::pianomaniaForceNormalizeSlursFingerings = false;
int MScore::pianomaniaNormalizedManualSlurs = 0;
int MScore::pianomaniaNormalizedManualFingerings = 0;
int MScore::pianomaniaManualReviewFingerings = 0;
...
void MScore::resetPianomaniaSlurFingeringDiagnostics()
{
    pianomaniaNormalizedManualSlurs = 0;
    pianomaniaNormalizedManualFingerings = 0;
    pianomaniaManualReviewFingerings = 0;
}
