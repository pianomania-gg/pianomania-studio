...
public:
    void setNoteIndex(int index) {_noteIndex = index;}
    ...
    enum class PianomaniaHand : unsigned char {
        Undefined = 0,
        Left = 1,
        Right = 2
    };
    enum class PianomaniaHeldNotePulse : int {
        None = 0,
        Quarter = 4,
        Eighth = 8,
        Sixteenth = 16,
    ...
    void setPianomaniaHeldNote(bool val)
    {
        m_pianomaniaHeldNote = val;
        if (!val) {
            m_pianomaniaHeldNotePulse = PianomaniaHeldNotePulse::None;
            m_pianomaniaHeldNotePulseTriplet = false;
            m_pianomaniaHeldNotePitchCurve.clear();
        }
    }
    bool pianomaniaHeldNote() const { return m_pianomaniaHeldNote; }
    void setPianomaniaHeldNotePulse(PianomaniaHeldNotePulse val)
    {
        m_pianomaniaHeldNotePulse = val;
        if (val == PianomaniaHeldNotePulse::None) {
            m_pianomaniaHeldNotePulseTriplet = false;
        }
    }
    PianomaniaHeldNotePulse pianomaniaHeldNotePulse() const { return m_pianomaniaHeldNotePulse; }
    void setPianomaniaHeldNotePulseTriplet(bool val) { m_pianomaniaHeldNotePulseTriplet = val; }
    bool pianomaniaHeldNotePulseTriplet() const { return m_pianomaniaHeldNotePulseTriplet; }
    static bool isValidPianomaniaHeldNotePitchCurve(const PianomaniaHeldNotePitchCurve& curve, int durationTicks = 0);
    int pianomaniaHeldNoteDurationTicks() const;
    void setPianomaniaHeldNotePitchCurve(const PianomaniaHeldNotePitchCurve& curve) { m_pianomaniaHeldNotePitchCurve = curve; }
    const PianomaniaHeldNotePitchCurve& pianomaniaHeldNotePitchCurve() const { return m_pianomaniaHeldNotePitchCurve; }
    void setPianomaniaHand(PianomaniaHand val) { m_pianomaniaHand = val; }
    PianomaniaHand pianomaniaHand() const { return m_pianomaniaHand; }
    void setPianomaniaShakeNote(bool val) { m_pianomaniaShakeNote = val; }
    bool pianomaniaShakeNote() const { return m_pianomaniaShakeNote; }
    void assignPianomaniaHandFromStaff();
...
private:
    ...
    bool m_pianomaniaHeldNote = false;  // PianoMania held note property
    PianomaniaHeldNotePulse m_pianomaniaHeldNotePulse = PianomaniaHeldNotePulse::None;
    bool m_pianomaniaHeldNotePulseTriplet = false;
    PianomaniaHeldNotePitchCurve m_pianomaniaHeldNotePitchCurve;
    PianomaniaHand m_pianomaniaHand = PianomaniaHand::Undefined;
    bool m_pianomaniaShakeNote = false;  // PianoMania bass-shake note property
