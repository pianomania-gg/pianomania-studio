...
public:
    ...
    bool cmdAddRubatoZone();
    bool cmdAddPyroSpan();
    bool cmdAddLaserSpan();
    ...
    void togglePianomaniaHeldNotes(const std::vector<Note*>&);
    void setPianomaniaHeldNotePulse(const std::vector<Note*>&, int);
    void setPianomaniaHeldNotePulseTriplet(const std::vector<Note*>&, bool);
    bool setPianomaniaHeldNotePitchCurve(const std::vector<Note*>&, const PianomaniaHeldNotePitchCurve&);
    void togglePianomaniaShakeNotes(const std::vector<Note*>&);
