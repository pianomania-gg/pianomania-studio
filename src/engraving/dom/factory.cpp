...
EngravingItem* Factory::doCreateItem(ElementType type, EngravingItem* parent)
{
    ...
    case ElementType::RUBATO_ZONE:       return new RubatoZone(parent);
    case ElementType::PYRO_SPAN:         return new PyroSpan(parent);
    case ElementType::LASER_SPAN:        return new LaserSpan(parent);
...
CREATE_ITEM_IMPL(RubatoZone, ElementType::RUBATO_ZONE, EngravingItem, isAccessibleEnabled)

CREATE_ITEM_IMPL(PyroSpan, ElementType::PYRO_SPAN, EngravingItem, isAccessibleEnabled)

CREATE_ITEM_IMPL(LaserSpan, ElementType::LASER_SPAN, EngravingItem, isAccessibleEnabled)
