...
public:
    ...
    static bool showPianomaniaHands;
    static bool pianomaniaPrettifySlursFingerings;
    static bool pianomaniaForceNormalizeSlursFingerings;
    static int pianomaniaNormalizedManualSlurs;
    static int pianomaniaNormalizedManualFingerings;
    static int pianomaniaManualReviewFingerings;

    static void resetPianomaniaSlurFingeringDiagnostics();
