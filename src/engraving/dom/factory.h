...
public:
    ...
    static RubatoZone* createRubatoZone(EngravingItem* parent, bool isAccessibleEnabled = true);

    static PyroSpan* createPyroSpan(EngravingItem* parent, bool isAccessibleEnabled = true);

    static LaserSpan* createLaserSpan(EngravingItem* parent, bool isAccessibleEnabled = true);
