...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::PIANOMANIA_HELD_NOTE,    false, "pianomaniaHeldNote",    P_TYPE::BOOL,               PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "PianoMania held note") },
    { Pid::PIANOMANIA_HAND,         false, "pianomaniaHand",        P_TYPE::INT,                PropertyGroup::APPEARANCE,      DUMMY_QT_TR_NOOP("propertyName", "PianoMania hand") },
