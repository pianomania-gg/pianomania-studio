...
static constexpr PropertyMetaData propertyList[] = {
    ...
    { Pid::PIANOMANIA_HELD_NOTE,                P_TYPE::BOOL,                      PropertyGroup::APPEARANCE, false, "pianomaniaHeldNote",              QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania held note") },
    { Pid::PIANOMANIA_HELD_NOTE_PULSE,          P_TYPE::INT,                       PropertyGroup::APPEARANCE, false, "pianomaniaHeldNotePulse",         QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania held note pulse") },
    { Pid::PIANOMANIA_HELD_NOTE_PULSE_TRIPLET,  P_TYPE::BOOL,                      PropertyGroup::APPEARANCE, false, "pianomaniaHeldNotePulseTriplet",  QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania held note pulse triplet") },
    { Pid::PIANOMANIA_HELD_NOTE_PITCH_CURVE,    P_TYPE::PIANOMANIA_HELD_NOTE_PITCH_CURVE, PropertyGroup::APPEARANCE, false, "pianomaniaHeldNotePitchCurve", QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania held note pitch curve") },
    { Pid::PIANOMANIA_HAND,                     P_TYPE::INT,                       PropertyGroup::APPEARANCE, false, "pianomaniaHand",                  QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania hand") },
    { Pid::PIANOMANIA_SHAKE_NOTE,               P_TYPE::BOOL,                      PropertyGroup::APPEARANCE, false, "pianomaniaShakeNote",             QT_TRANSLATE_NOOP("engraving/propertyName", "PianoMania shake note") },
