...
class RubatoZone;
class RubatoZoneSegment;
class PyroSpan;
class PyroSpanSegment;
class LaserSpan;
class LaserSpanSegment;
class ShadowNote;
...
#define CONVERT(a, b) \
    ...
    CONVERT(RubatoZone,     RUBATO_ZONE)
    CONVERT(RubatoZoneSegment, RUBATO_ZONE_SEGMENT)
    CONVERT(PyroSpan,       PYRO_SPAN)
    CONVERT(PyroSpanSegment, PYRO_SPAN_SEGMENT)
    CONVERT(LaserSpan,      LASER_SPAN)
    CONVERT(LaserSpanSegment, LASER_SPAN_SEGMENT)
...
CONVERT(RubatoZone)
CONVERT(RubatoZoneSegment)
CONVERT(PyroSpan)
CONVERT(PyroSpanSegment)
CONVERT(LaserSpan)
CONVERT(LaserSpanSegment)
CONVERT(Rasgueado)
