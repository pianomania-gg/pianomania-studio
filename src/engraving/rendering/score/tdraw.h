...
private:
    ...
    static void draw(const RubatoZoneSegment* item, muse::draw::Painter* painter, const PaintOptions& opt);
    static void draw(const PyroSpanSegment* item, muse::draw::Painter* painter, const PaintOptions& opt);
    static void draw(const LaserSpanSegment* item, muse::draw::Painter* painter, const PaintOptions& opt);
