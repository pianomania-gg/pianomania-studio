...
public:
    ...
    static void layoutRubatoZoneSegment(RubatoZoneSegment* item, LayoutContext& ctx);
    static void layoutPyroSpanSegment(PyroSpanSegment* item, LayoutContext& ctx);
    static void layoutLaserSpanSegment(LaserSpanSegment* item, LayoutContext& ctx);
