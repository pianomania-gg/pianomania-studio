...
private:
    ...
    static void avoidCollisions(SlurSegment* slurSeg, const Shape& segShapes, PointF& pp1, PointF& p2, PointF& p3, PointF& p4,
                                muse::draw::Transform& toSystemCoordinates, double& slurAngle);
    static Shape getSegmentShapes(SlurSegment* slurSeg, ChordRest* startCR, ChordRest* endCR, bool localSingleSystemCrossStaff);
