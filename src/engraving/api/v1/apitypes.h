...
enum class ElementType {
    ...
    RUBATO_ZONE_SEGMENT   = int(mu::engraving::ElementType::RUBATO_ZONE_SEGMENT),
    PYRO_SPAN_SEGMENT     = int(mu::engraving::ElementType::PYRO_SPAN_SEGMENT),
    LASER_SPAN_SEGMENT    = int(mu::engraving::ElementType::LASER_SPAN_SEGMENT),
    ...
    RUBATO_ZONE           = int(mu::engraving::ElementType::RUBATO_ZONE),
    PYRO_SPAN             = int(mu::engraving::ElementType::PYRO_SPAN),
    LASER_SPAN            = int(mu::engraving::ElementType::LASER_SPAN),
