...
// Pianomania owns the canonical staff size; keep one source of truth so the
// default a score gets in the editor matches what the coordinated export applies.
...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    styleDef(pageWidth,                                  254.0 / INCH),
    styleDef(pageHeight,                                 190.5 / INCH),   // 10 in x 7.5 in
    styleDef(pagePrintableWidth,                         224.0 / INCH),
    ...
    styleDef(enableIndentationOnFirstSystem,             false),
    ...
    styleDef(spatium,                                    pm::PmPageGeometry::spatiumLayoutUnits),
