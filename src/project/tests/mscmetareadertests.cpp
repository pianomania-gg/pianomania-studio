...
{
    // MODULE_TEST_DATA_ROOT is the repo root (Pianomania export tests read fixtures across modules).
    const auto absolutePath = stdfs::path(project_test_DATA_ROOT) / "src/project/tests/data" / relativePath;
