...
public:
    ...
    void init();
    void deinit() {} // no real MIDI device (wasm/headless)

    std::vector<MidiDevice> availableDevices() const override;
    async::Notification availableDevicesChanged() const override { return async::Notification(); }

    Ret connect(const MidiDeviceID& deviceID) override;
    void disconnect() override;
    bool isConnected() const override;
    MidiDeviceID deviceID() const override;
    async::Notification deviceChanged() const override { return async::Notification(); }
