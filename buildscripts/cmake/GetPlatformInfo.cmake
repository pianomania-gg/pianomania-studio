...
# EMSCRIPTEN / CMAKE_SYSTEM_NAME are set by the Emscripten toolchain and are
# reliable; the compiler-path regex breaks when the compiler resolves to em++.bat
# (e.g. via Qt's wasm toolchain on Windows), so check the toolchain markers first.
if(EMSCRIPTEN OR CMAKE_SYSTEM_NAME STREQUAL "Emscripten" OR ${CMAKE_CXX_COMPILER} MATCHES "/em\\+\\+(-[a-zA-Z0-9.])?$")
    set(OS_IS_WASM 1)
