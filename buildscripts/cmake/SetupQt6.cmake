...
if (OS_IS_WASM)
    # Headless converter (no editor UI): Qt for WebAssembly also does not ship
    # several of the desktop add-ons (e.g. NetworkAuth). Keep only what the
    # conversion path needs. Expand if a kept module fails to find a Qt target.
    # Qt for WebAssembly does not ship Core5Compat / NetworkAuth / Concurrent.
    # Qml/Quick/Widgets are pulled in by the shared precompiled header (pch.h);
    # they exist in the wasm kit so we request them to satisfy it. (Could be
    # dropped later by disabling MUSE_COMPILE_USE_PCH for a slimmer binary.)
    set(_components
        Core
        Gui
        Widgets
