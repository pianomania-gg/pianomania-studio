...
if (OS_IS_WASM)
    set(PIANOMANIA_ACTIVE_QT_VERSION "6.8.3")
else()
    set(PIANOMANIA_ACTIVE_QT_VERSION "${PIANOMANIA_MUSESCORE_QT_VERSION}")
endif()

find_package(Qt6 ${PIANOMANIA_ACTIVE_QT_VERSION} EXACT REQUIRED COMPONENTS ${qt_components})
