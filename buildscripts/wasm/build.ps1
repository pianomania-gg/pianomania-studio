...
.DESCRIPTION
    ...
    NOTE: Qt 6.2.4 (this fork's QT_MIN_VERSION / desktop kit) has no WebAssembly
    build in the installer, so the wasm target uses a newer Qt. The headless
    converter excludes GUI/QML modules, where most newer-Qt breakage lives.
