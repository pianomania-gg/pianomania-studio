...
find "${VOLUME}/${LONGER_NAME}.app/Contents/Frameworks" -maxdepth 1 -type f \( -name '*.dylib' -o -name '*.so' \) -exec codesign --force --options runtime -s "Developer ID Application: MuseScore" '{}' ';'
